...
/* Blocos / Widgets Direito (.rich-panel) */
#barraDireita .bloco, 
#baseLayout .rich-panel, 
.blocoDireita {
    background: #fff !important;
    border-radius: 12px !important;
    border: 1px solid #e2e8f0 !important;
...
#barraDireita .tituloBloco, 
#baseLayout .rich-panel-header, 
.blocoDireita .tituloBloco {
    background: #fff !important;
    color: #1a2233 !important;
...
#barraDireita .conteudoBloco, 
#baseLayout .rich-panel-body, 
.blocoDireita .conteudoBloco {
    padding: 16px !important;
    font-size: 12px !important;
    color: #475569 !important;
    background: #fff !important;
}
#barraDireita .conteudoBloco ul, 
#baseLayout .rich-panel-body ul, 
.blocoDireita .conteudoBloco ul {
    padding: 0 !important; margin: 0 !important; list-style: none !important;
}
#barraDireita .conteudoBloco li, 
#baseLayout .rich-panel-body li, 
.blocoDireita .conteudoBloco li {
    margin-bottom: 10px !important; border-bottom: 1px solid #f1f5f9 !important; padding-bottom: 10px !important;
}
#barraDireita .conteudoBloco li:last-child, 
#baseLayout .rich-panel-body li:last-child, 
.blocoDireita .conteudoBloco li:last-child {
